  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-8 grid grid-cols-3 items-center">
        {/* Left: Name */}
        <Link href="/" className={`justify-self-start text-xl font-serif font-medium tracking-wide ${pathname === '/' ? 'bg-[#2C2A29] text-[#F9F8F6] px-4 py-2 rounded-full' : 'text-[#111111] hover:text-stone-600'} transition-colors no-underline`}>
          Yixuan Li
        </Link>
